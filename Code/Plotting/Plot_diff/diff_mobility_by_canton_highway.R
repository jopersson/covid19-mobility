...
###############################################################################
### diff plot highway mobility by canton                                    ###
###############################################################################

# read data
dta <- read_csv(file=here::here("Data","MIP_data","Highway_trips_ColumnE","highway_trips_canton_per_day_2020.csv"))
...
# save plot
ggsave(filename = "./Plots/parallel_trends/diff_mobility_by_canton_highway.pdf", plot = diff_plot, width = 8, height = 3)
