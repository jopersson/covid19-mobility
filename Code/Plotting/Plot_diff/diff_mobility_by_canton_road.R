...
###############################################################################
### diff plot road mobility by canton                                       ###
###############################################################################

# read data
dta <- read_csv(file=here::here("Data","MIP_data","Road_trips_ColumnD","road_trips_canton_per_day_2020.csv"))
...
# save plot
ggsave(filename = "./Plots/parallel_trends/diff_mobility_by_canton_road.pdf", plot = diff_plot, width = 8, height = 3)